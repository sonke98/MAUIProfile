...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 137, ; uint32_t number_of_assemblies_in_apk (0x89)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 642, ; uint32_t number_of_dso_cache_entries (0x282)
	i32 33555188, ; uint32_t android_runtime_jnienv_class_token (0x20002f4)
	i32 100671150, ; uint32_t jnienv_initialize_method_token (0x6001eae)
	i32 100671149, ; uint32_t jnienv_registerjninatives_method_token (0x6001ead)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [642 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-Xamarin.GooglePlayServices.Tasks.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
		i64 119522282513760569, ; hash 0x1a8a0e1f7fa0139, from name: libaot-Xamarin.GooglePlayServices.Base
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.55_name, ; name: libaot-Xamarin.GooglePlayServices.Base.dll.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-Xamarin.AndroidX.Biometric.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.57_name, ; name: libaot-Xamarin.GooglePlayServices.Location.dll.so
		ptr null; void* handle (0x0)
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.104_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 20
	%struct.DSOCacheEntry {
		i64 584895086741024446, ; hash 0x81df6fb8411eebe, from name: aot-Microsoft.CSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-Microsoft.CSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 43
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Fingerprint.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2705174192170743940, ; hash 0x258ab5985be43884, from name: libaot-personspontaneous
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 92
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.93_name, ; name: libaot-System.Runtime.Serialization.Formatters.dll.so
		ptr null; void* handle (0x0)
	}, ; 100
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Xamarin.AndroidX.VersionedParcelable.dll.so
		ptr null; void* handle (0x0)
	}, ; 126
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4190989949451613715, ; hash 0x3a2963277a4bb613, from name: aot-personspontaneous
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 149
	...
	%struct.DSOCacheEntry {
		i64 7141174365812108600, ; hash 0x631a8c40095b2d38, from name: aot-personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 231
	...
	%struct.DSOCacheEntry {
		i64 13069017414426794947, ; hash 0xb55e7a18864d9bc3, from name: personspontaneous
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 458
	...
	%struct.DSOCacheEntry {
		i64 14782742466663384842, ; hash 0xcd26d9f37b8d870a, from name: personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 520
	...
	%struct.DSOCacheEntry {
		i64 16737006834940800491, ; hash 0xe845cb0a37ee6deb, from name: libaot-personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 586
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7ab6bf70-567d-42f4-959c-c44523874324\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.personspontaneous\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-personspontaneous.dll.so\00", align 16
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [24 x i8] c"libaot-CsvHelper.dll.so\00", align 16
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [33 x i8] c"libaot-Plugin.Fingerprint.dll.so\00", align 16
...
@.DSOCacheEntry.30_name = private unnamed_addr constant [41 x i8] c"libaot-Xamarin.AndroidX.Biometric.dll.so\00", align 16
...
@.DSOCacheEntry.51_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
...
@.DSOCacheEntry.55_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 16
...
@.DSOCacheEntry.57_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 16
@.DSOCacheEntry.58_name = private unnamed_addr constant [47 x i8] c"libaot-Xamarin.GooglePlayServices.Tasks.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [31 x i8] c"libaot-Microsoft.CSharp.dll.so\00", align 16
...
@.DSOCacheEntry.74_name = private unnamed_addr constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
...
@.DSOCacheEntry.93_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 16
...
@.DSOCacheEntry.104_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
