...
@dso_cache = dso_local local_unnamed_addr global [642 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 56084199, ; hash 0x357c6e7, from name: libaot-personspontaneous
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 756903454, ; hash 0x2d1d6e1e, from name: personspontaneous
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 3010715241, ; hash 0xb373de69, from name: personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 464
	...
	%struct.DSOCacheEntry {
		i64 3373752553, ; hash 0xc91760e9, from name: aot-personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
	...
	%struct.DSOCacheEntry {
		i64 3558170283, ; hash 0xd4155eab, from name: aot-personspontaneous
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 536
	...
	%struct.DSOCacheEntry {
		i64 3621290358, ; hash 0xd7d88176, from name: libaot-personspontaneous.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-personspontaneous.dll.so
		ptr null; void* handle (0x0)
	}, ; 545
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [137 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7ab6bf70-567d-42f4-959c-c44523874324\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.personspontaneous\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-personspontaneous.dll.so\00", align 1
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [24 x i8] c"libaot-CsvHelper.dll.so\00", align 1
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [33 x i8] c"libaot-Plugin.Fingerprint.dll.so\00", align 1
...
@.DSOCacheEntry.30_name = private unnamed_addr constant [41 x i8] c"libaot-Xamarin.AndroidX.Biometric.dll.so\00", align 1
...
@.DSOCacheEntry.51_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 1
...
@.DSOCacheEntry.55_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 1
...
@.DSOCacheEntry.57_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 1
@.DSOCacheEntry.58_name = private unnamed_addr constant [47 x i8] c"libaot-Xamarin.GooglePlayServices.Tasks.dll.so\00", align 1
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [31 x i8] c"libaot-Microsoft.CSharp.dll.so\00", align 1
...
@.DSOCacheEntry.93_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 1
...
@.DSOCacheEntry.104_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 1
